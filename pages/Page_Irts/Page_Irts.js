	...
	<ScrollView bounces={false} showsVerticalScrollIndicator={false} style={{height: Dimensions.get("window").height}}>
		<Animated.View style={[{}, noneModeStyles._page2]}    >
			<View style = {noneModeStyles._activity}    >
				<Text style = {noneModeStyles._Activity} onStartShouldSetResponder = {() => {return true}} onResponderGrant = {() => {}} onResponderRelease = {() => {onClick_Activity();}}>
					ИРЦ
				</Text>
			...
			<View style = {noneModeStyles._activity_2}    >
				...
				<View style = {noneModeStyles._Group_2}    >
					...
					<View style = {noneModeStyles._Group_3}    >
						<Text style = {noneModeStyles._Amarachi_Nkechi_3}   >
							Н. Намуун
						</Text>
						<Text style = {noneModeStyles._Updated_file_on_Resp_2}   >
							Оруулсан хичээл : Responden data
						</Text>
					</View>
				</View>
				...
				<View style = {noneModeStyles._Group_9}    >
					<View style = {noneModeStyles._vscode_icons_file_type_pdf}    >
						...
						<View style = {noneModeStyles._layer_1bd272}    >
							<View style = {noneModeStyles._layer_bc1e79}   >
						...
						<View style = {noneModeStyles._layer_8508f4}    >
							<View style = {noneModeStyles._layer_8268e7}   >
						...
						<View style = {noneModeStyles._layer_03395c}    >
							<View style = {noneModeStyles._layer_0be10f}   >
						...
						<View style = {noneModeStyles._layer_5cc34d}    >
							<View style = {noneModeStyles._layer_e8ddf6}   >
								<Svg style={{height: 10, width: 10}} viewBox = "0 0 10 10">
						...
						<View style = {noneModeStyles._layer_006f3b}    >
							<View style = {noneModeStyles._layer_93dad3}   >
						...
						<View style = {noneModeStyles._layer_e6fb07}    >
							<View style = {noneModeStyles._layer_296376}   >
								<Svg style={{height: 8, width: 22}} viewBox = "0 0 22 8">
				...
				<View style = {noneModeStyles._Group_11}    >
					<View style = {noneModeStyles._vscode_icons_file_type_photoshop2}    >
						...
						<View style = {noneModeStyles._layer_066bdf}    >
							<View style = {noneModeStyles._layer_50b1d6}   >
								<Svg style={{height: 35, width: 27}} viewBox = "0 0 27 35">
									<Path fill = {"#070444"}     d = "M19.0775 0H0V35H26.1375V7.36L19.1637 0.09L19.0775 0Z"/>
								</Svg>
							</View>
						</View>
						<View style = {noneModeStyles._layer_295d0f}    >
							<View style = {noneModeStyles._layer_69e83b}   >
								<Svg style={{height: 10, width: 26}} viewBox = "0 0 26 10">
									<Path fill = {"#5BC3F6"}     d = "M0 0H25.8886V9.99999H0V0Z"/>
								</Svg>
							</View>
						</View>
						<View style = {noneModeStyles._layer_ace460}    >
							<View style = {noneModeStyles._layer_d7fe10}   >
						...
						<View style = {noneModeStyles._layer_49db88}    >
							<View style = {noneModeStyles._layer_869d66}   >
						...
						<View style = {noneModeStyles._layer_4211c7}    >
							<View style = {noneModeStyles._layer_7a6ff8}   >
